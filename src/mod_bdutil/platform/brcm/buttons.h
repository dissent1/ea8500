...
#elif defined( _HONDA ) || defined( _F70 ) || defined( _LEMANS ) || defined( _ESPRIT ) || defined( _R8 )
#define GPIO_RESET_PIN			11
...
typedef int (*irq_func_t) (int, void *);
...
#define BOARD_GPIO_WIFI_PIN     GPIO_WIFI_PIN
